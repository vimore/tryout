 ...
 */
public class GzInputPathFilter extends Configured implements PathFilter {
    private static final Logger LOGGER = LoggerFactory.getLogger(GzInputPathFilter.class);
