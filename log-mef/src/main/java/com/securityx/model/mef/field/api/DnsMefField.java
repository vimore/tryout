...
public enum DnsMefField implements SupportedFormat {
    ...
    dnsRecordTTL(1, MefFieldType.data, "dns", "TTL of the DNS entry",
...
// end of CEF fields ---------------------------------------------------------
    ...
    private DnsMefField(int numberOfValues,
    ...
    public SupportedFormat getByPrettyName(String prettyName) {
        ...
        try {
            format = DnsMefField.valueOf(prettyName);
