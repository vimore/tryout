...
public enum HETMefField implements SupportedFormat {
    ...
    deviceInterface(1, MefFieldType.data, "device", "CEF device inbound interface",
...
//Arrays.<MefFieldConstrait>asList(new MefMilliSecTimeStampConstraint()), LongMarshall.class,"setReceiptTime", Long.class, true),
    ...
    eventOutcome(1, MefFieldType.metaData, null, "CEF event outcome, reason of the failure usually",
    ...
    private HETMefField(int numberOfValues,
    ...
    public SupportedFormat getByPrettyName(String prettyName) {
        ...
        try {
            format = HETMefField.valueOf(prettyName);
