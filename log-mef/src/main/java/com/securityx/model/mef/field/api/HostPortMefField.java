...
public enum HostPortMefField implements SupportedFormat {
...
//Arrays.<MefFieldConstrait>asList(new MefMilliSecTimeStampConstraint()), LongMarshall.class,"setEndTime", Long.class, true),
    ...
    processListenPort(1, MefFieldType.data, "process", "port process is listenning to",
            Arrays.<MefFieldConstrait>asList(new MefIntegerConstraint()), IntMarshall.class, "setProcessListenPort", Integer.class, true),
    processListenAddress(1, MefFieldType.data, "process", "IP address of the interface if listening to, 0.0.0.0 if listening to all interface",
            Arrays.<MefFieldConstrait>asList(new MefInetAddressConstraint()), StringMarshall.class, "setProcessListenAddress", CharSequence.class, true),
    ...
    private HostPortMefField(int numberOfValues,
    ...
    private void initSupportedFormatFields() {
        for (HostPortMefField field : values()) {
    ...
    public SupportedFormat getByPrettyName(String prettyName) {
        ...
        try {
            format = HostPortMefField.valueOf(prettyName);
