...
public enum HostProcessMefField implements SupportedFormat {
...
//Arrays.<MefFieldConstrait>asList(new MefStringConstraint()), StringMarshall.class,"setDeviceFacility", CharSequence.class, true),
    ...
    deviceUserName(1, MefFieldType.data, "device", "username executing the process  (login)",
...
//Arrays.<MefFieldConstrait>asList(new MefMilliSecTimeStampConstraint()), LongMarshall.class,"setEndTime", Long.class, true),
    ...
    processPorts(1, MefFieldType.data, "process", "process open ports format protocol/interface:port",
            Arrays.<MefFieldConstrait>asList(new MefStringConstraint()), StringMarshall.class, "setProcessPorts", CharSequence.class, true),
    ...
    private HostProcessMefField(int numberOfValues,
    ...
    private void initSupportedFormatFields() {
        for (HostProcessMefField field : values()) {
    ...
    public SupportedFormat getByPrettyName(String prettyName) {
        ...
        try {
            format = HostProcessMefField.valueOf(prettyName);
