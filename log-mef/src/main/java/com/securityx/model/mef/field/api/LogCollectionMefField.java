...
import com.securityx.model.mef.field.marshaller.FloatMarshall;
...
public enum LogCollectionMefField implements SupportedFormat {
...
uuid(1, MefFieldType.data, null, "Event uuid collected from rawlog or crafted",
  ...
  receiptTime(1, MefFieldType.data, null, "time raw message has been received",
Arrays.<MefFieldConstrait>asList(new MefMilliSecTimeStampConstraint()), LongMarshall.class,"setStartTime", Long.class, true),
transactionId(1, MefFieldType.data, null, "Application level protocol such as: HTTP, HTTPS, SSHv2, Telnet, POP, IMAP, IMAPS, etc.",
...
queryRTT(1, MefFieldType.data, "query", "RTT of the DNS query in sec",
Arrays.<MefFieldConstrait>asList(new MefFloatConstraint()), FloatMarshall.class,"setQueryRTT", Float.class, true),
query(1, MefFieldType.data, "query", "DNS query",
Arrays.<MefFieldConstrait>asList(new MefStringConstraint()), StringMarshall.class,"setQuery", CharSequence.class, true),
queryType(1, MefFieldType.data, "dns", "DNS response type",
Arrays.<MefFieldConstrait>asList(new MefStringConstraint()), StringMarshall.class,"setQueryType", CharSequence.class, true),
dnsRecordName(1, MefFieldType.data, "dns", "DNS entry name",
Arrays.<MefFieldConstrait>asList(new MefStringConstraint()), StringMarshall.class,"setDnsRecordName", CharSequence.class, true),
logBytes(1, MefFieldType.data, null, "event raw log   ",
Arrays.<MefFieldConstrait>asList(new MefIntegerConstraint()), IntMarshall.class,"setDnsRecordTTL", Integer.class, true),
dnsRecordIp(1, MefFieldType.data, "dns", "DNS entry resolved to Ip",
Arrays.<MefFieldConstrait>asList(new MefInetAddressConstraint()), StringMarshall.class,"setDnsRecordIp", CharSequence.class, true),
dnsRecordType(1, MefFieldType.data, "dns", "DNS entry type",
Arrays.<MefFieldConstrait>asList(new MefStringConstraint()), StringMarshall.class,"setDnsRecordTypes", CharSequence.class, true),
...
replyCode(1, MefFieldType.data, "dns", "DNS reply code",
Arrays.<MefFieldConstrait>asList(new MefStringConstraint()), StringMarshall.class,"setReplyCode", CharSequence.class, true),
...
;
  ...
  private LogCollectionMefField(int numberOfValues,
  ...
  private void initSupportedFormatFields() {
    for (LogCollectionMefField field : values()){
  ...
  public SupportedFormat getByPrettyName(String prettyName) {
    ...
    try{
      format = LogCollectionMefField.valueOf(prettyName);
