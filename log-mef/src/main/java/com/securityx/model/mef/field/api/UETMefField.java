...
public enum UETMefField implements SupportedFormat {
...
//Arrays.<MefFieldConstrait>asList(new MefStringConstraint()), StringMarshall.class,"setDeviceFacility", CharSequence.class, true),
    ...
    deviceUserName(1, MefFieldType.data, "device", "Connected username (login)",
            Arrays.<MefFieldConstrait>asList(new MefStringConstraint()), StringMarshall.class, "setDeviceUserName", CharSequence.class, true),
    deviceUserFullName(1, MefFieldType.data, "device", "Connected username full name",
            Arrays.<MefFieldConstrait>asList(new MefStringConstraint()), StringMarshall.class, "setDeviceUserFillName", CharSequence.class, true),
    deviceUserEmailAddress(1, MefFieldType.data, "device", "Connected username email address",
            Arrays.<MefFieldConstrait>asList(new MefStringConstraint()), StringMarshall.class, "setDeviceUserEmailAddress", CharSequence.class, true),
...
//Arrays.<MefFieldConstrait>asList(new MefMilliSecTimeStampConstraint()), LongMarshall.class,"setEndTime", Long.class, true),
    ...
    cpuConsumption(1, MefFieldType.data, "device", "device host cpu consumption in %",
            Arrays.<MefFieldConstrait>asList(new MefFloatConstraint()), FloatMarshall.class, "setCpuConsumption", CharSequence.class, true),
    ...
    private UETMefField(int numberOfValues,
    ...
    public SupportedFormat getByPrettyName(String prettyName) {
        ...
        try {
            format = UETMefField.valueOf(prettyName);
