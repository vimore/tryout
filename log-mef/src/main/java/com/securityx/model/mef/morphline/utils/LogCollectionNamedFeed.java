...
/**
 * log collection feeder, use a morphline script to extract data from container
 * attached as morphline records. Processing chain has to be aware of the record
 * format to be able to process de data
 *
 * @author jyrialhon
 */
public class LogCollectionNamedFeed implements Feed<Record[]> {
   ...
   */
  public LogCollectionNamedFeed(String name, Command morphline) {
    this.name = name;
