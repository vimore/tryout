...
public class WebProxySquidCombinedSyslogTest extends LogCollectionAbstractTest {

  private Logger logger = LoggerFactory.getLogger(MefBluecoatScriptTest.class);

  public WebProxySquidCombinedSyslogTest(String name) {
    super(name);
    this.morphlineId = "squidcombinedfromrsyslog";
    this.confFile = "webproxy-squid.conf";
  }

  @Test
  public void test_http200() throws FileNotFoundException {
    String line = "(squid):   81.56.112.95 - - [28/Feb/2014:08:32:35 -0500] \"GET http://www.squid-cache.org/Doc/config/logformat/ HTTP/1.1\" 304 431 \"http://wiki.squid-cache.org/Features/LogFormat\" \"Mozilla/5.0 (Windows NT 6.1; WOW64; rv:27.0) Gecko/20100101 Firefox/27.0\" TCP_REFRESH_UNMODIFIED:DIRECT";
