...
public class TaniumHostLoggedInUserToUETMefTest extends LogCollectionAbstractTest {

    private Logger logger = LoggerFactory.getLogger(TaniumHostLoggedInUserToUETMefTest.class);
    private MorphlineHarness morphlineTanium2Json;
    private AssertRecordOutCommand tanium2JsonOutCommand;

    public TaniumHostLoggedInUserToUETMefTest() throws Exception {
        super(TaniumHostLoggedInUserToUETMefTest.class.toString());
        ...
        this.morphlineId = "tanium-logged_in_users";
        this.confFile = "uetmef-tanium-logged_in_users.conf";
    }
        ...
        for (int i=0; i < this.outCommand.getNumRecords();i++) {
            ...
            switch (i){
                case 0:
                    ...
                    assertEquals("taniumQuestion", "Hosts-Logged in user details", out.get("taniumQuestion").get(0));
